...
source("/Users/hlg5155/Documents/GitHub/Somalia/AXA-PSU-Somalia/Core/Code/2_Extract_tmin_CHIRTS_1.R" )
...
#   source(paste(dir_code,"3_MissingReplace.R",sep=sep))
   ...
   if((nchar(modified) > 0)&(is.na(modified)==FALSE)){
      ...
      StemIn  <- paste(family,dataset,version,"Raw",sep="_")
      StemOut <- paste(family,dataset,version,"Geo",sep="_")
   }   source("/Users/hlg5155/Documents/GitHub/Somalia/AXA-PSU-Somalia/Core/Code/2_Extract_rhum_CHIRTS_1.R" )
   setwd(dir_core)
