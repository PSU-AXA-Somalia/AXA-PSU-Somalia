...
if(("Step0_GedoPROJECT.Rproj" %in% list.files())){
   dir_main <- substr(getwd(),start=1,stop=nchar(getwd()))
}else{     
   if("dir_main" %in% ls()){
...
#Level 0 
dir_GLOBALCODE         <-  paste(dir_main,"../../Core",sep=sep)
...
#Data Level 1
# tweak 5 had to change line 43
if(is.na(RemoteData)){
   dir_data        <- paste(dir_runset,"Data",sep=sep)
}else{
   dir_data        <- RemoteData
}
...
dir_analysis_raw <- paste(dir_main, "Output1_RawPlots ",sep=sep)
dir_analysis_vis <- paste(dir_main, "Output2_Visualisation ",sep=sep)
...
dir_data_remote_CDerived_2anom  <-  paste(dir_data_remote_CDerived,"B_Anomalies",sep=sep)
dir_data_remote_CDerived_3thresh  <-  paste(dir_data_remote_CDerived,"C_Threshold",sep=sep)


#Data Level 6
dir_data_remote_CDerived_dekad_clim  <-  paste(dir_data_remote_CDerived_1climate,"C_Clim_data_dekad",sep=sep)
dir_data_remote_CDerived_month_clim  <-  paste(dir_data_remote_CDerived_1climate,"D_Clim_data_month",sep=sep)
dir_data_remote_CDerived_dekad_anom  <-  paste(dir_data_remote_CDerived_2anom,"C_Clim_data_dekad",sep=sep)
dir_data_remote_CDerived_month_anom  <-  paste(dir_data_remote_CDerived_2anom,"D_Clim_data_month",sep=sep)
dir_data_remote_CDerived_dekad_thresh  <-  paste(dir_data_remote_CDerived_3thresh,"C_Clim_data_dekad",sep=sep)
dir_data_remote_CDerived_month_thresh <-  paste(dir_data_remote_CDerived_3thresh,"D_Clim_data_month",sep=sep)
...
create <- sapply(c(dir_data_remote_CDerived_1climate,
                   dir_data_remote_CDerived_2anom,
                   dir_data_remote_CDerived_3thresh),conditionalcreate,silent=TRUE)

#Data Level 6
create <- sapply(c(dir_data_remote_CDerived_dekad_clim,dir_data_remote_CDerived_month_clim,
                   dir_data_remote_CDerived_dekad_anom,dir_data_remote_CDerived_month_anom,
                   dir_data_remote_CDerived_dekad_thresh,dir_data_remote_CDerived_month_thresh),conditionalcreate,silent=TRUE)
